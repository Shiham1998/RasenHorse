...
const StoreReviewScreen = ({navigation}) => {
  ...
  return (
    ...
    <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
      ...
      {/* <View style={{backgroundColor:'white',height:150,marginHorizontal:20,marginVertical:-10,padding:10,borderRadius:15,marginBottom:35}}>
      <Text style={{fontWeight:'bold',color:'black',marginLeft:25}}>Items</Text>
...
/>
<Text style={{marginRight:65,fontSize:15,fontWeight:'700',color:'black'}}>Horse Saddle</Text>


<Text style={{marginRight:15,color:Colors.PROJECT_S5,
  fontWeight:'500',
  fontSize:15,
  marginRight:15}}>$27.00</Text>
...
<View style={{height:100,paddingVertical:20,flex:1,marginTop:35,marginLeft:20}}>
    ...
    <Text style={{fontSize:15,fontWeight:'bold',color:'black'}}>x2</Text>
</View>

<Text style={{fontSize:15,fontWeight:'bold',color:'black'}}>$270.00</Text>
    </View>
      
      <View style={{backgroundColor:'white',height:230,marginHorizontal:20,marginVertical:-10,padding:10,borderRadius:15,marginBottom:25}}>
      <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',marginTop:20}}>
      <Text style={styles.cardtext}>Subtotal</Text>
        <View>
        <Text style={styles.cardtext1}>$272.00</Text>
        </View>
      </View>
      <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',marginTop:20}}>
      <Text style={styles.cardtext}>Shipping Free</Text>
        <View>
...
<View style={{height:100,paddingVertical:20,flex:1,marginTop:35,marginLeft:20}}>
      ...
      <TouchableOpacity
        ...
        <Text style={{fontSize:20,fontWeight:'bold',color:'white',letterSpacing:1}} onPress={()=>navigation.navigate('StoreAddressScreen')} >Confirm Payment</Text>
      </TouchableOpacity>
      </View>
