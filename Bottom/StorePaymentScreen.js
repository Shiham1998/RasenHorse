...
const StorePaymentScreen = ({navigation}) => {
  return (
...
<View style={{height:100,paddingVertical:20,flex:1,marginTop:35,marginLeft:20}}>
    ...
    <TouchableOpacity
        ...
        >
        <Text style={{fontSize:20,fontWeight:'bold',color:'white',letterSpacing:1}} onPress={()=>navigation.navigate('StoreCardScreen')}>Continue</Text>
      </TouchableOpacity>
  </SafeAreaView>
  )
}
