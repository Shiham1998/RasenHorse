  ...
  return (
    ...
    <View style={styles.inputContainer}>
      <View style={styles.inputSubContainer}>
        ...
        <TextInput placeholder='Email' placeholderTextColor={Colors.DEFAULT_GREY} selectionColor={Colors.DEFAULT_GREY} style={styles.inputText}/>
      </View>
    </View>
...
<Image source={images.GOOGLE} style={styles.signinButtonLogo}/>
    ...
    {/* <View style={styles.signupContainer}>
      ...
      <Text style={styles.signupText} onPress={()=>navigation.navigate('Signup')}>Register</Text>
    </View> */}
    </View>
  )
}
